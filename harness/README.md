...
> 本目录为 Mavis 多项目追踪系统的 Harness 子项目结构
...
```bash
# 单项目
python3 /workspace/knowledge-base/_index/scripts/weekly_runner.py --project harness
...
- 本地: `/workspace/knowledge-base/projects/harness/`
