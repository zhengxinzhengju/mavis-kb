...
> 本目录为 Mavis 多项目追踪系统的 OpenClaw 子项目结构
...
```bash
# 单项目
python3 /workspace/knowledge-base/_index/scripts/weekly_runner.py --project openclaw
...
- 本地: `/workspace/knowledge-base/projects/openclaw/`
